...
def templates() -> rx.Component:
    return rx.box(
        rx.box(
            rx.text("👋Hi there!", class_name="text-slate-20 text-3xl font-semibold mb-4"),
            rx.markdown(
                'This is an agent built on the <span style="color: #FF6C00; font-weight: 600;">newest technologies</span> that can use tools and reasoning based on high quality data sources to answer your questions.',
                class_name="text-slate-11 text-sm",
